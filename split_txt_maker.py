...
parser.add_argument('--split_ratio_train', type=float, default=0.7, help = "split_ratio for train")
parser.add_argument('--split_ratio_val', type=float, default=0.2, help = "split_ratio for val")
