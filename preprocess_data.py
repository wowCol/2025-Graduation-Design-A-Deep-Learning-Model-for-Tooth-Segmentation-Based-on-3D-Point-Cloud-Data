...
parser.add_argument('--source_obj_data_path', required=True, type=str, help="data path in which original .obj data are saved")
parser.add_argument('--source_json_data_path', required=True, type=str, help="data path in which original .json data are saved")
parser.add_argument('--save_data_path', required=True, type=str, help="data path in which processed data will be saved")
